...
fn main() {
    ...
    while !window.should_close() {
        ...
        let camera_x = RADIUS * (glfw.get_time().cos() as f32);
        let camera_z = RADIUS * (glfw.get_time().sin() as f32);
        let view = Matrix4::<f32>::look_at(Point3::new(camera_x, 0.0, camera_z), Point3::new(0.0, 0.0, 0.0), vec3(0.0, 1.0, 0.0));
        let projection = perspective(Deg(45.0), 800.0 as f32 / 600.0 as f32, 0.1, 100.0);
