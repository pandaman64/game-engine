...
use cgmath::{Matrix4, vec3, vec4, Deg, perspective, InnerSpace, Point3};
...
fn main() {
    ...
    let cube_vao = unsafe {
        ...
        let stride = conv!(mem::size_of::<f32>() * 8);
        let offset1 = (3 * mem::size_of::<f32>()) as *const _;
        let offset2 = (5 * mem::size_of::<f32>()) as *const _;
