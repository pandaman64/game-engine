...
use cgmath::{Matrix4, vec3, Deg, perspective, Rad};
use gl::types::*;
...
fn main() {
    ...
    while !window.should_close() {
        ...
        let model: Matrix4<f32> = Matrix4::from_angle_x(Rad(glfw.get_time() as f32 % (2.0 * std::f32::consts::PI)));
