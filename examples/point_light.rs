...
const FRAGMENT_SHADER_SOURCE: &str = r#"
    ...
    void main()
    {
        ...
        FragColor = vec4(CalcPointLight(light, norm, viewDir), 1.0);
    } 
"#;
...
fn main() {
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            shader_program.set_vec3(c_str!("light.position"), light_pos.x, light_pos.y, light_pos.z);
            ...
            shader_program.set_float(c_str!("light.constant"), 1.0);
            shader_program.set_float(c_str!("light.linear"), 0.09);
            shader_program.set_float(c_str!("light.quadratic"), 0.032);
