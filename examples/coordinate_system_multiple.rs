...
use cgmath::{Matrix4, vec3, Deg, perspective, InnerSpace};
use gl::types::*;
...
fn main() {
    ...
    while !window.should_close() {
        ...
        let time = ((glfw.get_time() % 10.0) / 10.0) as f32;
        let projection = perspective(Deg(15.0 * time + 89.0 * (1.0 - time)), 800.0 as f32 / 600.0 as f32, 0.1, 100.0);
