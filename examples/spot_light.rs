...
const FRAGMENT_SHADER_SOURCE: &str = r#"
    ...
    void main()
    {
        ...
        FragColor = vec4(CalcSpotLight(light, norm, viewDir), 1.0);
    } 
"#;
...
fn main() {
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            shader_program.set_vec3(c_str!("light.position"), camera_pos.x, camera_pos.y, camera_pos.z);
            shader_program.set_vec3(c_str!("light.direction"), camera_dir.x, camera_dir.y, camera_dir.z);
            shader_program.set_float(c_str!("light.cutOff"), 12.5_f32.to_radians().cos());
            shader_program.set_float(c_str!("light.outerCutOff"), 17.5_f32.to_radians().cos());
