...
fn main() {
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            shader_program.set_vec3(c_str!("material.ambient"), 1.0, 0.5, 0.31);
            shader_program.set_vec3(c_str!("material.diffuse"), 1.0, 0.5, 0.31);
            shader_program.set_vec3(c_str!("material.specular"), 0.5, 0.5, 0.5);
